...
export const elevatedRoofing: ProspectData = {
  slug: "elevated-roofing",
  ...
  projectImages: [
    {
      src: "https://elevatedroofing.com/wp-content/uploads/2025/12/Mega-Menu-Comprehensive-Residential-Roofing-Services-in-DFW-Elevated-Roofing-1-1.jpg",
      label: "Elevated residential roofing service visual"
    },
    {
      src: "https://elevatedroofing.com/wp-content/uploads/2025/12/Mega-Menu-Roofing-Insurance-Claims-Deductible-Assistance-Elevated-Roofing-.jpg",
      label: "Elevated insurance claim guidance visual"
    }
  ],
  brand: {
    primary: "#1F5E3B",
  ...
  sourceWebsite: "https://elevatedroofing.com/service-areas/fort-worth/",
