...
export const houstonRoofingConstruction: ProspectData = {
  slug: "houston-roofing-construction",
  ...
  primaryService: "no-cost Houston roof inspection",
  recommendedCta: "Schedule Free Roof Inspection",
  secondaryCta: "Use Website Contact",
  trustSignal: "Free inspection page advertises licensed, certified roofers, no-cost inspection, free quotes, and no sales pressure",
  projectImages: [],
  brand: {
    primary: "#174B7A",
    primaryDark: "#082B4D",
  ...
  sourceWebsite: "https://houstonroofingonline.com/residential-roofing/free-roof-inspection/",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "The first action is to request the no-cost Houston roof inspection, then review visible findings before deciding whether repair, replacement, emergency service, or quote next steps are needed."
    },
    {
